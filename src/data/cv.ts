...
export const CV = {
  ...
  experience: [
    {
      position: "Freelance UI/UX designer and Frontend Engineer",
      company: "Self-employed",
      period: "Nov 2023 — now",
      type: "project & contract work",
    ...
    {
      position: "Software Engineer (Design System)",
    ...
    {
      position: "UI Engineer, Consultant",
      company: "Workademy GmbH",
      period: "2020",
      type: "Part-time project work",
      location: "Berlin, Germany",
      description:
    ...
    },
    {
      ...
      company: "Various agencies and clients",
      period: "2009 — 2016",
      type: "Freelance",
      location: "Ukraine",
      description:
  ...
  stack: {
    frameworks: ["React", "TypeScript", "Next.js", "Vue", "Nuxt"],
